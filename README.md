...
## 注意点
+ 公式にサポートされていない部分は日本語にならない。
+ トランシーバーの使用者表示は日本語名を表示できない。
+ 特定の条件で中国語フォントが読み込まれ、一部の漢字が中文表記や□になったりすることがある？

## 更新履歴
2026/06/11 顔文字を日本式に変更。<br>
2026/05/25 使えないと思っていた漢字(撃、隠など)が使えたので、それらを避けていた部分を修正。<br>
2026/05/24 ベータ v0.4.4.3に対応。<br>
